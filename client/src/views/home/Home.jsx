...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const currentCards = allDrivers.slice(indexOfFirstCard, indexOfLastCard);
  ...
  return (
    <div>
      ...
      <Paginado currentPage={currentPage} totalPages={totalPages} paginate={paginate} nextPage={nextPage} prevPage={prevPage} />
    </div>
  );
}
/*      useEffect (() => {
